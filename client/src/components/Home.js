            ...
            <div className="hours-grid">
              {["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"].map((day, idx) => (
                <div className="hours-column" key={idx}>
                  ...
                  <div className="time">
                    {[
                      "5:00 PM – 9:00 PM", "5:00 PM – 10:00 PM", "5:00 PM – 10:00 PM",
                      "5:00 PM – 10:00 PM", "5:00 PM – 10:00 PM",
                      "5:00 PM – 12:00 AM", "5:00 PM – 12:00 AM"
                    ][idx]}
                  </div>
        ...
        <div className="menu-preview-overlay">
          <div className="menu-preview-content">
            <div className="menu-text">
              <p className="menu-subtitle" style={{ fontFamily: 'Great Vibes, cursive', fontSize: '22px', color: '#e6cfa7' }}>
                Taste the mood
              </p>
              <h2 className="menu-heading" style={{ fontFamily: 'Playfair Display, serif', fontSize: '48px', color: '#fdf4d4' }}>
                Our Menu
              </h2>
